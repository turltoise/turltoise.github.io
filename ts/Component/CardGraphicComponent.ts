...
class CardGraphicComponent extends AbstractGraphicComponent {
    ...
    private _combatAnimation: number;

    private _templateCardContainer: HTMLElement;
    private _templateCardTitle: HTMLElement;
    private _templateCardImg: HTMLElement;
    private _templateCardDesc: HTMLElement;
    private _templateCardStatContainer: HTMLElement;
    private _templateCardStat: HTMLElement;
    private _templateStatElem: HTMLElement;
    private _templateStyle: HTMLElement;
    private _instanceCardLife: HTMLElement;
    private _instanceHover: HTMLElement;
    ...
    constructor(container: Container, card: AbstractPrintableCard) {
        ...
        const instanceCardContainer : HTMLElement = <HTMLElement> this._templateCardContainer.cloneNode(true);
        ...
        const instanceCardTitle : HTMLElement = <HTMLElement> this._templateCardTitle.cloneNode(true);
        instanceCardTitle.innerHTML = this._title;

        const instanceCardImg : HTMLImageElement = <HTMLImageElement> this._templateCardImg.cloneNode(true);
        instanceCardImg.innerHTML = "Card Img";
        instanceCardImg.src = "img/"+this._img;

        const instanceCardDesc : HTMLElement = <HTMLElement> this._templateCardDesc.cloneNode(true);
        ...
        this._instanceHover = <HTMLElement> templateHover.cloneNode(true);
        this._instanceAnimationDamage = <HTMLElement> templateAnimationDamage.cloneNode(true);
        this._instanceAnimationDie = <HTMLElement> templateAnimationDie.cloneNode(true);
