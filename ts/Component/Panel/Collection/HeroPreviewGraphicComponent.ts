...
class HeroPreviewGraphicComponent extends AbstractGraphicComponent {
    ...
    constructor(container: Container, card: Hero, templateContainerCard: HTMLElement) {
        super(container);
        this._card = card;
        ...
        this._itemListContainer = <HTMLElement> this.getCurrentDocument().createElement('div');
    ...
    displayItemList()
    {
        ...
        this._card.getItemMap().forEach((item: Item) => {
            cursorCard++;
