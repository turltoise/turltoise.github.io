...
/* BEGIN -------------  FOR TESTS */
const myCarac = new RawCarac(3, //strength=null,
3, //dexterity=null,
3, //intelligence=null,
3, //luck=null,
...
const cardA = new Hero(mainContainer, myCarac, 1, "My card A", "illidan.webp", capacities1);
const myCollection = mainContainer.get(Collection.name);
myCollection.addCard(cardA);
myCollection.addCard(new Hero(mainContainer, myCarac, 1, "My card B", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 2, "My card C", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 3, "My card D", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 4, "My card E", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 5, "My card F", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 6, "My card G", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 7, "My card H", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 8, "My card I", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 9, "My card J", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 10, "My card K", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 11, "My card L", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 12, "My card M", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 13, "My card N", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 14, "My card O", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 15, "My card P", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 16, "My card Q", "illidan.webp", capacities1));
myCollection.addCard(new Hero(mainContainer, myCarac, 17, "My card R", "illidan.webp", capacities1));
