...
const myMainScreen = new MainScreen(myCombatPanel, myCollectionPanel, myOpeningPanel, myShopPanel);
...
const myBody = new BodyGraphicComponent(myState, myCombatPanel, myCollectionPanel, myOpeningPanel, myShopPanel, myChatComponent);
