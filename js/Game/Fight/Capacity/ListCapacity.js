...
class ListCapacity {
    constructor(state) {
        this._state = state;
        this._list.set("life_steal_sword_strike", function (thrower, target) {
        ...
        this._list.set("physical_attack", function (thrower, target) {
        ...
        this._list.set("fire_ball", function (thrower, target) {
        ...
        this._list.set("poison", function (thrower, target) {
        ...
        this._list.set("attack_buff", function (thrower, target) {
...
//# sourceMappingURL=ListCapacity.js.map